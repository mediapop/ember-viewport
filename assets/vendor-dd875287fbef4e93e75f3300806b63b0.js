...
this.setProperties({height:e,width:t}),document.documentElement.style.setProperty("--vh","calc("+e+"px / 100)")}"undefined"!=typeof document&&"undefined"!=typeof window&&(this.resize.on("didResize",e.bind(this)),e.call(this)),this._super.apply(this,arguments)}})}),define("ember-ajax/-private/promise",["exports"],function(e){"use strict"
